...
Este documento describe los datos que produce `mi-primer-estudio` en el checkpoint 06.

## Organización del archivo de datos

El archivo `datos_<participante>.csv` tiene una fila por pantalla. La cantidad de filas depende del recorrido de cada persona:
